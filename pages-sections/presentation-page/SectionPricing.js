...
export default function SectionPricing() {
  ...
  return (
    <div className={classes.section} style={{ backgroundImage: "url('/img/web/register-image.svg')" }} >
        ...
        <GridContainer>
          ...
          <div className={classes.socialLine}>
            <div className={classes.container}>
              <GridContainer>
                <GridItem md={12}>
                  <h4 className={classes.title} style={{color: 'white'}}>Thank you for sharing!</h4>
